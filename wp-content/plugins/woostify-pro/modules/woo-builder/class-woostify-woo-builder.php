...
if ( ! class_exists( 'Woostify_Woo_Builder' ) ) {
	...
	class Woostify_Woo_Builder {
		...
		public function enqueue_assets() {
			...
			wp_add_inline_style( 'woostify-style', '.elementor-widget-woostify-my-account .account-menu-item.active a, .elementor-widget-woostify-my-account .account-menu-item a:hover { color: ' . esc_attr( $options['theme_color'] ) . ';fill: ' . esc_attr( $options['theme_color'] ) . '; }' );
		}
	}
