...
if ( ! class_exists( 'Woostify_Variation_Swatches' ) ) :
	...
	class Woostify_Variation_Swatches {
		...
		public function register_settings() {
			...
			register_setting( 'variation-swatches-settings', 'woostify_variation_swatches_url_active' );
		}
		...
		public function get_options() {
			...
			$options['url_variation_active'] = get_option( 'woostify_variation_swatches_url_active', '1' );
						...
						<div class="woostify-settings-content">
							...
							<div class="woostify-settings-section-content">
								<table class="form-table">
									...
									<tr class="woostify-filter-item">
										<th scope="row"><?php esc_html_e( 'Url variation active', 'woostify-pro' ); ?>:</th>
										<td>
											<label for="woostify_variation_swatches_url_active">
												<input name="woostify_variation_swatches_url_active" type="checkbox" id="woostify_variation_swatches_url_active" value="<?php echo esc_attr( $options['url_variation_active'] ); ?>"  <?php checked( $options['url_variation_active'], '1' ); ?> >
												<?php esc_html_e( 'Add variation active on url.', 'woostify-pro' ); ?>
											</label>
										</td>
									</tr>
								</table>
