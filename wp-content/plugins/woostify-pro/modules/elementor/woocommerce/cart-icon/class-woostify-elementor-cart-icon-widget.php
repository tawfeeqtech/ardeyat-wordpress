...
class Woostify_Elementor_Cart_Icon_Widget extends Widget_Base {
	...
	public function cart_icon() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .custom-svg-icon svg path, {{WRAPPER}} .shopping-bag-button svg' => 'fill: {{VALUE}};',
				),
				'condition' => array(
		...
		$this->add_control(
			'icon_color_hover',
			array(
				'label'     => __( 'Icon Color Hover', 'woostify-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .shopping-bag-button:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .custom-svg-icon:hover svg path, {{WRAPPER}} .shopping-bag-button:hover svg' => 'fill: {{VALUE}};',
				),
				'condition' => array(
					'type' => array( 'icon', 'theme' ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'{{WRAPPER}} .shopping-bag-button'     => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .shopping-bag-button svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'type' => array( 'icon', 'theme' ),
				),
