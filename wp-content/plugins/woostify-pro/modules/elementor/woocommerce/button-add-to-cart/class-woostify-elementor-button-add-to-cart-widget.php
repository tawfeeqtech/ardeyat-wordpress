	...
	protected function button_style() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .woostify-button-add-to-cart .button svg' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .woostify-button-add-to-cart .button' => 'color: {{VALUE}};fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .woostify-button-add-to-cart .button:hover' => 'color: {{VALUE}};fill: {{VALUE}};',
				),
			)
		);
