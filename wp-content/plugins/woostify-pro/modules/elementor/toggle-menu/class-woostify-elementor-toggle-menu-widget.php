...
class Woostify_Elementor_Toggle_Menu_Widget extends Widget_Base {
	...
	public function icon() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .position-icon-left .vertical-menu-button .woostify-svg-icon'  => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .position-icon-right .vertical-menu-button .woostify-svg-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .vertical-menu-button .woostify-svg-icon svg' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'icon_typo',
				'selector' => '{{WRAPPER}} .toggle-vertical-menu-button .icon-toogle-vertical:before, {{WRAPPER}} .vertical-menu-button .icon-toogle-vertical:before',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .vertical-menu-button .woostify-svg-icon svg, {{WRAPPER}} .vertical-menu-button .woostify-svg-icon svg path' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .vertical-menu-button:hover .woostify-svg-icon svg, {{WRAPPER}} .vertical-menu-button:hover .woostify-svg-icon svg path' => 'fill: {{VALUE}};',
				),
			)
		);
