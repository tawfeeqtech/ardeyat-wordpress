...
if ( ! class_exists( 'Woostify_Pro' ) ) {
	...
	class Woostify_Pro {
		...
		public function woostify_pro_dashboard_static() {
			...
			if ( $screen->post_type || $is_countdown_urgency || $is_swatches || $is_sale_notification || $is_ajax_search_product || $is_smart_product_filter || $is_welcome || $is_pre_order || $is_callback) {
				wp_enqueue_script(
