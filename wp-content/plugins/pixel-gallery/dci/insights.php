...
if ( ! class_exists( 'Insights_SDK' ) ) {
	...
	class Insights_SDK {
		...
		public function data_prepare( $params ) {
			 ...
			 */
			$custom_data = array(
				'active_modules' => get_option( 'pixel_gallery_active_modules', false ),
				'third_party'    => get_option( 'pixel_gallery_third_party_widget', false ),
				'extend'         => get_option( 'pixel_gallery_elementor_extend', false ),
			);
